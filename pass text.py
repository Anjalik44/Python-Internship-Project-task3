...
class GUI:
    ...
    def accept_fields(self):
        ...
        gen_passwd = self.n_generatedpassword.get()

        if not name or not gen_passwd:
        ...
        with sqlite3.connect("users.db") as db:
            ...
            if cursor.fetchall():
                ...
                cursor.execute("INSERT INTO users (Username, GeneratedPassword) VALUES (?, ?)", (name, gen_passwd))
                db.commit()
